...
class DBViewerApp:
    ...
    def _bootstrap(self) -> None:
        ...
        try:
            ...
            self.ui.db_select.value = self.state.current_db if self.state.current_db in dbs else (dbs[0] if dbs else None)
    ...
    def _render_tables_meta(self) -> None:
        ...
        with self.ui.tables_meta_output:
            ...
            # 想定カラム: table_name, row_count, total_size, data_size
            # 無い場合にも落ちないようにガード
            col_map = {
                "table_name": "table",
                "row_count": "rows",
